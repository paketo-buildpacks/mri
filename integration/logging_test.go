	...
	context("when the buildpack is run with pack build", func() {
		...
		it("logs useful information for the user", func() {
			...
			Expect(logs).To(ContainLines(
				...
				"",
				"    WARNING: Setting the MRI version through buildpack.yml will be deprecated soon in MRI Buildpack v0.1.0.",
				"    Please specify the MRI version through an environment variable configurtion. See README.md for how to do this.",
				"",
